...
//  来源网站
    ...
    public Task(String id, String title, String term, String pay, String bid, String content, String link, String outType, String outTypeName, String inType, String inTypeName, String source) {
        this.id = id;
        this.title = title;
        this.term = term;
        this.pay = pay;
